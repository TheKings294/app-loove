export class Dock
{
    ...
    render(navigate, parent)
    {
        ...
        document.querySelector("#homeBtn").addEventListener("click", (e) => navigate("home"))
        document.querySelector("#inboxBtn").addEventListener("click", (e) => navigate("inbox"))
        document.querySelector("#settingsId").addEventListener("click", (e) => navigate("settings"))
